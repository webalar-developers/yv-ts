	...
	return (
		<div className={cn("flex flex-col gap-3", className)}>
			...
			<a
				...
				className="flex h-14 w-48 items-center justify-center rounded-xl bg-black text-white transition-all hover:bg-black/80 active:scale-95"
			>
				<div className="mr-3">
					<svg
						viewBox="0 0 384 512"
						width="24"
						role="img"
						aria-labelledby="apple-icon-title"
					>
						<title id="apple-icon-title">Apple Icon</title>
						<path
							fill="currentColor"
			...
			>
				<div className="mr-3">
					<svg
						...
						width="24"
						role="img"
						aria-labelledby="google-play-icon-title"
					>
						<title id="google-play-icon-title">Google Play Icon</title>
						<path
							fill="#FFD400"
